...
DATABASES = {
    'default': {
        ...
        'NAME': 'djblog.db',                      # Or path to database file if using sqlite3.
...
ALLOWED_HOSTS = ['www.cupfox.com','cupfox.com','*']
...
SECRET_KEY = 'takd)1#_q++3dnbq9w(%5yp4hnonx6rig8cy-yv=47g2be)g85'
